...
import { links, socialLinks } from './shared/_data'
  ...
  <Box as="footer" bg={mode('gray.50', 'gray.800')}>
    <Box maxW={{ base: 'xl', md: '7xl' }} mx="auto" px={{ base: '6', md: '8' }} py={{ base: '12', md: '20' }}>
      ...
      >
        ...
        <Box flex="2" maxW={{ lg: '420px' }} ml={{ lg: 'auto' }} fontSize="sm" mt={{ base: '12', lg: 0 }}>
          <Text casing="uppercase" mb={{ base: 6, lg: 10 }} fontWeight="bold" letterSpacing="wide">
            Subscribe to our newsletter!
          </Text>
          <Text lineHeight="tall">
            Get Overflow resources, curated content, and design inspiration delivered straight into your
            inbox. Be the first to learn the news about new features and product updates.
          </Text>
          <SubscribeForm />
        </Box>
      </Flex>
      ...
      >
        ...
        <Box>
          <Text>&copy; {new Date().getFullYear()} StockChase Financial</Text>
          <Text mt="2">
            Made with <Heart /> by StockChase
          </Text>
        </Box>
      </Flex>
    </Box>
